...
| **Milestone 19 (v0.9.9)** | DEV-058 | Adaptive Onboarding, Genesis Dashboard & Agentic AI Workflow Enforcement | `test_agent_rules.py`, `test_genesis_onboarding.py` | [Spec](specs/spec-DEV-058-adaptive-onboarding-and-progressive-disclosure.md) |
